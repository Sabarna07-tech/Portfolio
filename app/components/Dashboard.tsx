    ...
    <section className="py-12 sm:py-16 md:py-20 bg-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        <ScrollReveal>
          <div className="flex items-center gap-3 sm:gap-4 mb-10 sm:mb-12 md:mb-16">
            <h3 className="font-headline font-extrabold flex items-center text-xl sm:text-2xl md:text-3xl">
              <Activity className="text-secondary mr-2 sm:mr-3 w-6 h-6 sm:w-8 sm:h-8" /> Telemetry &amp; Activity
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 md:gap-8">
          {/* GitHub Stats */}
          <ScrollReveal delay={0.1} className="md:col-span-8 glass-panel p-4 sm:p-6 md:p-8 rounded-2xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="relative z-10 mb-4 sm:mb-6 md:mb-8">
              <h4 className="font-headline font-bold text-sm sm:text-base md:text-lg text-on-surface mb-2 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                <span>GitHub Contribution Graph</span>
                <span className="text-[10px] sm:text-xs font-mono text-on-surface-variant font-normal">
            ...
            <div className="relative z-10 bg-surface-container-highest/30 p-2 sm:p-3 md:p-4 rounded-xl border border-white/5">
              <Heatmap data={heatmapData} />
            </div>
          </ScrollReveal>

          {/* LeetCode Stats */}
          <ScrollReveal delay={0.2} className="md:col-span-4 glass-panel p-5 sm:p-6 md:p-8 rounded-2xl">
            <h4 className="font-headline font-bold text-base sm:text-lg text-on-surface mb-6 sm:mb-8 flex justify-between items-center">
              LeetCode Telemetry
