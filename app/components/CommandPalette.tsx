...
export default function CommandPalette() {
  ...
  const commands: Command[] = useMemo(
    () => [
      ...
      { id: 'activity', label: 'Currently Building', hint: 'Live GitHub activity', group: 'Navigate', keywords: 'recent repos latest now', icon: <Radio className={ICON} />, run: () => scrollTo('activity') },
